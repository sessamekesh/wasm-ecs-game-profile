// https://github.com/eliemichel/LearnWebGPU-Code/blob/step211/resources/compute-shader.wgsl
@group(0) @binding(0) var previousMipLevel: texture_2d<f32>;
@group(0) @binding(1) var nextMipLevel: texture_storage_2d<rgba16float,write>;
